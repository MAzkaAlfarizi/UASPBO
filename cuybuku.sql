...
('PL001', 'Sahrul Hidayat', 'L', 'Jalan Dukuh Depok'),
('PL002', 'Mochamad Azka Alfarizi', 'L', 'Jalan Mangga Tangerang'),
('PL003', 'Keisha Sasikirana Putri', 'P', 'Jalan jalan Bekasi'),
('PL004', 'Mang Uus', 'L', 'Jalan Sapi Jakarta utara');
